...
async def maintenance_loop(worker_manager: WorkerManagersConnectionHandler, command_execution: CommandExecution,
...
def main():
    ...
    current_unique_id = str(uuid.uuid1())
    ...
    worker_manager = WorkerManagersConnectionHandler(internal_vm_comms, current_unique_id)
